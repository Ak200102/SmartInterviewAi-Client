...
const Pricing = () => {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-50 to-cyan-50 py-16 px-6'>
      <div className='max-w-6xl mx-auto mb-14 items-start gap-4'>
        ...
        <div className='text-center w-full'>
          ...
          <p className='text-gray-500 mt-3 text-lg'>Flexible pricing to match your innterview preparation goals.</p>
        </div>
      </div>
      <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto'>
        {plans.map((plan)=>{
          ...
          return(
            ...
            className={`relative rounded-3xl p-8 transition-all duration-300 border ${isSelected ? "border-cyan-600 shadow-xl shadow-blue-200 bg-white" : "border-gray-200 bg-white shadow-md"
            ...
            >
              ...
              <div className='mt-4'>
                <span className='text-3xl font-bold text-cyan-600'>{plan.price}
                </span>
              ...
              transition ${
                isSelected ? "bg-cyan-600 text-white hover:opacity-90" :
