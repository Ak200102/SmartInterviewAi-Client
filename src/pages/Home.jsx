      ...
      <div className='flex-1 px-6 py-20'>
        <div className='max-w-6xl mx-auto'>
          ...
          rounded-full flex items-center gap-2'>
              <LuBotMessageSquare size={16} className='bg-blue-50 text-blue-600' />
          ...
          <div className='text-center mb-28'>
            ...
            <motion.p
              ...
              Role-based mock interviews with smart follows-ups, adaptive difficulty and real-time performance analysis.
            </motion.p>
              ...
              [
                {
                  ...
                  desc: "AI adjust difficulty based on your answers."
                },
                {
                  icon: <BsMic size={24} />,
                  step: "STEP 2",
                ...
                <motion.div key={index}
                  ...
                  className={`relative bg-white rounded-3xl border-2 border-blue-100 hover:border-blue-500 p-10 w-80 max-w-[90%] shadow-md hover:shadow-2xl
              transition-all duration-300
              ${index === 0 ? "rotate-[-4deg]" : ""}
              ${index === 1 ? "rotate-[3deg] md:-mt-6 shadow-xl" : ""}
              ${index === 2 ? "rotate-[-3deg]" : ""}
              `}>
                  <div className='absolute -top-8 left-1/2 -translate-1/2 bg-white border-2 border-blue-500 text-blue-600 w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg'>
                    {item.icon}
                  </div>
            ...
            <div className='grid md:grid-cols-2 gap-10'>
              {
                [
                  ...
                  },
                  {
                    ...
                    desc: "Detailed streangths, weaknesses and improvement insights."
                  },
                  {
                    image: analyticsImg,
                    icon: <BsBarChart size={20} />,
                ...
                [
                  {
                    ...
                    desc: "Behavioral and communication based analysis."
                  },
                  {
                    img: techImg,
