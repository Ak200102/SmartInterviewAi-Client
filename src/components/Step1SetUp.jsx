        ...
        className='p-12 bg-white'>
          ...
          <div className='space-y-6'>
            <div className='relative'>
              ...
              <input type='text' placeholder='Enter role' className='w-full pl-12 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none
              transition'
            ...
            <div className='relative'>
              ...
              <input type='text' placeholder='Experience (e.g 2 years)' className='w-full pl-12 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none
              transition'
            ...
            <select value={mode} 
              ...
              className='w-full  py-3 px-4 border border-gray-200 rounded-xl focus:ring-blue-500 outline-none transition'>
              ...
              {analysisDone && (
               ...
               <motion.button 
                    ...
                    whileHover={{scale: 1.03}}
                    whileTap={{scale: 0.95}}
                  className='w-full disabled:bg-gray-600 bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-full text-lg font-semibold transition duration-300 shadow-md cursor-pointer'>{loading ? "Starting...":"Start Interview"}
                </motion.button>
          </div>
        </motion.div>
      </div>
