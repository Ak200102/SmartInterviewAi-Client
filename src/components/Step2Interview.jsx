...
const Step2Interview = ({ interviewData, onFinish }) => {
  ...
  useEffect(() => {
    ...
    const runIntro = async () => {
      if (isIntrophase) {
        await speakText(
          `Hi ${userName}, it's great to meet you today. I hope you're feeling cofident and ready.`
        );
        ...
        if (currentIndex === questions.length - 1) {
          await speakText("Alright, this one might be a bit more challengin");
        }
  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-blue-50 via-white to-blue-100 flex items-center justify-center p-4 sm:p-6'>
        ...
        <div className='flex-1 flex flex-col p-4 sm:p-6 md:p-8 relative'>
          ...
          { !feedback ? (<div className='flex items-center gap-4 mt-6'>
            ...
            disabled={isSubmitting}
              whileTap={{ scale: 0.95 }}
              className='flex-1 bg-gradient-to-r from-blue-600 to-cyan-500 text-white py-3 sm:py-4 rounded-2xl shadow-lg hover:opacity-90 transition font-semibold cursor-pointer disabled:bg-gray-500'>
            ...
            initial={{ opacity: 0}}
            animate={{ opacity: 1}}
            className='mt-6 bg-cyan-50 border border-cyan-200 p-5 roundedr-2xl shadow-sm'>
